...
console.log('Sakhi V3.7.0 source validation passed:');
...
console.log(' - slower detailed Kokoro desktop playback, server-side iOS af_heart, readiness gate and update-safe PWA present');
