...
if(!/4\.1\.0/.test(html))throw new Error('4.1.0 build marker missing');
...
console.log(' - 4.1.0 anti-repetition, parent curriculum control, adaptive challenge, focused narration, and visible math embedded');
