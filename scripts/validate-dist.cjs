...
if(!/4\.4\.0/.test(html))throw new Error('4.4.0 build marker missing');
...
console.log(' - 4.4.0 instant local narration, adaptive evidence, 141-skill syllabus, parent recommendations, and exact synced resume embedded');
