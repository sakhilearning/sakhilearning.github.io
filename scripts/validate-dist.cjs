...
if(!/3\.10\.1/.test(html))throw new Error('3.10.1 build marker missing');
...
console.log(' - 3.10.1 instant startup, tablet-safe transitions, and contextual scenes embedded');
