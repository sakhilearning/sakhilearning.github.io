...
if(!/3\.3\.0/.test(html))throw new Error('3.3.0 build marker missing');
...
if(/speechSynthesis|SpeechSynthesisUtterance|webkitSpeech|browserSpeak/.test(html))throw new Error('Robotic browser speech exists in deployment');
...
console.log(' - 3.3.0 screenshot-matched cinematic themes embedded');
