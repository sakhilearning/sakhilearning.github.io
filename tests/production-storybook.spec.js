...
test('parent curriculum shows evidence and distinguishes planned skills', async ({page}) => {
  ...
  await expect(page.locator('#domainProgress')).toContainText('Planned · not assessed');
