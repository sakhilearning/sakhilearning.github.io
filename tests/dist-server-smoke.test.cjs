...
(async () => {
  ...
  try {
    ...
    if (!sw.includes('sakhi-v3-3.8.0') || sw.includes('client.navigate') || sw.includes('clients.matchAll')) throw new Error('Built service worker must update without reload loops');
