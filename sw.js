...
const APP_ASSETS=['./build-info.js','./design-tokens.css','./styles.css','./interactions.css','./runtime-stability.css','./visuals.css','./kid-upgrade.css','./sakhi-shell.css','./settings-controls.css','./pwa-update.css','./supabase-config.js','./curriculum.js','./persistence.js','./phoneme-audio.js','./speech-service.js','./app.js','./settings-service.js','./adventure-service.js','./core-learning-services.js','./activity-contract.js','./reward-service.js','./scheduler.js','./interaction-engine.js','./challenge-bank.js','./foundation-verification-bank.js','./adaptive-acceleration-service.js','./ui-hooks.js','./progress-service.js','./parent-auth-service.js','./asset-service.js','./visuals.js','./kid-upgrade.js','./adaptive-engine.js','./backend-bridge.js','./sakhi-shell.js','./settings-ui.js','./pwa-update.js','./assets/audio/phonemes/phoneme_t.ogg','./assets/audio/phonemes/phoneme_p.ogg','./unicorn-icon.svg'];
